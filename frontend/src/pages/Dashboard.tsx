          ...
          {isProfileMenuOpen && (
            <div className="profile-popup-menu">
                ...
                <div 
                  ...
                  onClick={() => {
                    setIsProfileMenuOpen(false); // Tutup popup menu
                    // Logika penyeberangan:
                    navigate(isSeller ? '/merchant' : '/register-store');
                  }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
